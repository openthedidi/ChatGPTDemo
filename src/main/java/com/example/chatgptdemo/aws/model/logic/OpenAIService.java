...
public class OpenAIService {
    ...
    public QueryDetails generateQueryByString(String prompt) {
        ...
        userMessage.setContent("我的資料庫有以下的類似資訊，格式如下：{\\\"product_info\\\": {\\\"id\\\": \\\"115\\\", \\\"system_id\\\": \\\"HPCHI2\\\", \\\"title\\\": \\\"南山人壽全心溢靠2醫療保險(HPCHI2)\\\", \\\"product_description\\\": \\\"提供住院、手術及重大疾病三合一保障\\\", \\\"product_feature\\\": \\\"\\\", \\\"age\\\": \\\"10年期:0歲~60歲/20年期:0歲~50歲\\\", \\\"payment_method\\\": \\\"年繳/半年繳/季繳/月繳\\\", \\\"payment_period\\\": \\\"10年/20年\\\", \\\"currency\\\": \\\"新台幣\\\", \\\"main_list\\\": [\\\"主約\\\"], \\\"assure_list\\\": [\\\"滿期保險金\\\",\\\"身故\\\",\\\"重大疾病\\\",\\\"住院日額\\\",\\\"門診手術\\\",\\\"住院手術\\\",\\\"豁免保險費\\\",\\\"外溢回饋\\\"], \\\"tag_list\\\": [\\\"新台幣\\\"], \\\"detail_url\\\": {\\\"url\\\": \\\"/product/103/115\\\", \\\"url_blank\\\": false, \\\"url_type\\\": \\\"INSIDE\\\"}}}");
        Message userMessage2 = new Message();
        userMessage2.setRole("user");
        userMessage2.setContent("你可以幫我把以下這段話\\" + prompt + "\"，依據上面的類型，分析出可以歸類在age、payment_method、payment_period、assure_list的屬性嗎，如果沒有就填入空即可，請幫我回傳格式為age=value,payment_method=value就好，請不要用回答多餘的說明描述，我只要結果即可");
    ...
    public String generateResponseByString(String QueryResult) {
        ...
        Message userMessage = new Message();
        userMessage.setRole("user");
        userMessage.setContent("請幫我用適當的方生成以下內容：" + QueryResult);
